...
{
    [Activity(Label = "FR - Consulta de Cobros", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait, ConfigurationChanges = Android.Content.PM.ConfigChanges.KeyboardHidden | Android.Content.PM.ConfigChanges.Orientation | Android.Content.PM.ConfigChanges.ScreenSize)]
    public class ConsultaCobroView : MvxBindingActivityView<ConsultaCobroViewModel>
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.ConsultaCobros);            
            cmbCriterios = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCriterioscc);
