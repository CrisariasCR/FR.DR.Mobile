...
{
    [Activity(Label = "FR - Detalle Inventario", WindowSoftInputMode = SoftInput.AdjustPan, ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait, ConfigurationChanges = Android.Content.PM.ConfigChanges.KeyboardHidden | Android.Content.PM.ConfigChanges.Orientation | Android.Content.PM.ConfigChanges.ScreenSize)]
    public class DetalleInventarioView : MvxBindingActivityView<DetalleInventarioViewModel>
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.DetalleInventario);
            scanner = new MobileBarcodeScanner(this);
            
            this.cmbCriterios = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCriteriosci);
            this.cmbCompanias = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCompaniasci);
            ...
            this.txtBusqueda = (EditText)this.FindViewById(Resource.Id.txtBusquedadinv);
        ...
        {
            ViewModel.TextoBusquedadi = msg;
            ViewModel.TextoBusquedadi = string.Empty;
        }
