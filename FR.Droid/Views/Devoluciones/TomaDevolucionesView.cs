...
namespace FR.Droid.Views.Devoluciones
{
    ...
    public class TomaDevolucionesView : MvxBindingActivityView<TomaDevolucionesViewModel>
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.TomaDevoluciones);
            ...
            txtBusqueda = FindViewById<EditText>(Resource.Id.txtBusquedatd);
            ...
            this.cmbCompanias = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCompaniastd);
            this.cmbCriterios = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCriteriostd);
            this.cmbEstadoArticulo = FindViewById<MvxBindableSpinner>(Resource.Id.cmbCriteriostd);
        ...
        void onRadioButtonClicked(object sender, EventArgs e)
        {
            ...
            ViewModel.PagoEfectivo = view.Id == Resource.Id.radioEfectivo;
        }
