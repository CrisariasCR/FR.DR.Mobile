...
namespace FR.Droid.Views.Principal
{
    public class MenuParametrosAdapter : BaseAdapter
    {
        ...
        void FillParametros()
        {
            ...
            _parametrostList.Add("Par芍metros del Sistema");
            _parametrostList.Add("Consulta NCF");
			_parametrostList.Add("Parr芍etros del Dispositivo");
            _parametrostList.Add("Corporaci車n");
			_parametrostList.Add("Par芍metros de Impresi車n");
        }
        ...
        public override long GetItemId(int position)
        {
            ...
            {
				case "Par芍metros del Sistema": return 0;
                case "Consulta NCF": return 1;
				case "Par芍metros del Dispositivo": return 2;
                case "Corporaci車n": return 3;
				case "Par芍metros de Impresi車n": return 4;
                default: return -1;
            }
        }
