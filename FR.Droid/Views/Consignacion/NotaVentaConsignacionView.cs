...
{
    [Activity(Label = "FR - Nota a Venta en Consignación", WindowSoftInputMode = SoftInput.AdjustPan, ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait, ConfigurationChanges = Android.Content.PM.ConfigChanges.KeyboardHidden | Android.Content.PM.ConfigChanges.Orientation | Android.Content.PM.ConfigChanges.ScreenSize)]
    public class NotaVentaConsignacionView : MvxBindingActivityView<NotaVentaConsignacionViewModel>
    {
        EditText txtNotas;       
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.NotaVentaConsignacion);
