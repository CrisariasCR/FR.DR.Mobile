...
namespace Softland.ERP.FR.Mobile.Cls.Documentos.FRPedido
{
    ...
    /// </summary>
    public class DetalleGarantia : DetalleLinea, IPrintable
    {
        ...
        private DetalleGarantia lineaBonificada = null;
        /// <summary>
        /// Detalle de la linea bonificada por esta linea de pedido.
        /// </summary>
        public DetalleGarantia LineaBonificada
        {
        ...
        private DetalleGarantia lineaBonificadaAdicional = null;
        /// <summary>
        /// Detalle de la linea bonificada por esta linea de pedido.
        /// </summary>
        public DetalleGarantia LineaBonificadaAdicional
        {
        ...
        public void CargarBonificacion(Cls.FRCliente.ClienteCia cliente)
        {
            ...
            if (this.Articulo.Bonificaciones.Count != 0)
            {
                ...
                if (cantBonAlm > 0)
                {
                    ...
                    //if (!(Garantias.FacturarPedido && !bonificacion.ArticuloBonificado.Bodega.SuficienteExistencia(cantBonAlm)))
        ...
        public void RecalcularDetalle(decimal unidadesGarantia, decimal unidadesDetalle, Precio precio,
            NivelPrecio nivel, FRCliente.ClienteCia cliente, decimal porcDescuentoGeneral, bool cargarBonificaciones)
        {
            UnidadesAlmacen = unidadesGarantia;
            ...
            //No Calcula Descuento por ser DepGarantia
            ...
            //No Calcula Impuestos por ser DepGarantia
        ...
        public string[] OrdenarItems(CriterioArticulo criterio)
        {
            ...
            if (EsBonificada)
                itemes[colum] = DetalleGarantia.BONIFICADA;
            else if (EsBonificadaAdicional)
                itemes[colum] = DetalleGarantia.BONIFICADAADICIONAL;
            else
                itemes[colum] = DetalleGarantia.NOBONIFICADA;
