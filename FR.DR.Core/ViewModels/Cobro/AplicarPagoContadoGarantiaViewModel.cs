...
{
    public class AplicarPagoGarantiaViewModel : DialogViewModel<Dictionary<string, object>>
    {
...
#pragma warning disable 414
        ...
        public AplicarPagoGarantiaViewModel(string messageId)
            : base(messageId)
        {            
                ...
                Cobros.IniciarCobro(GlobalUI.ClienteActual, garantia.Compania);
                GlobalUI.ClienteActual.CargarNotasCredito(garantia.Compania);
                //Tipo de cobro
                ...
                if (AplicarPagoContadoViewModel.genCobro)
                {
                    ...
                    Cobros.MontoEfectivo = garantia.MontoNeto;
        ...
        private void SacarMontosFacturas()
        {
            ...
            if (esFacturaContado)
            {
                ...
                {
                        Cobros.MontoFacturasLocal = garantia.MontoNeto;                    
                }
                else
                {
                    Cobros.MontoFacturasDolar = garantia.MontoNeto;                    
                }
            }
            else
            {
        ...
        /// <summary>
        /// Genera un recibo en efectivo para la garantía de contado
        /// </summary>
        private void GenerarReciboEfectivo()
        {
            ...
            if (aplicarPago)
            {
                try
                {
                    ...
                    this.Recibo = Cobros.AplicarPagoContado(this.garantia);
        ...
        private void MostrarPantallaFacturas()
		{
            ...
            {
                //si hay compannia seleccionada se muestra la pantalla de seleccion de garantía
        ...
        public void CancelarPago()
        {
            if (esFacturaContado)
            {
                ...
                string mensaje = "¿Desea generar recibo en efectivo para la garantía? ";
        ...
        {
            //LJR 09/06/2009 Caso 35843: La forma de seleccionar una garantía se modifica
            //Forzar el evento check como la seleccion con click para refrescar datos
            ItemActual = facChecked;

            //Marcar la garantía como seleccionada
        ...
        /// <summary>
        /// Indica la garantía selecccionada
        /// </summary>
        private NotaCredito notaSeleccionada = new NotaCredito();

        /// <summary>
        /// Indica si hay una garantía seleccionada actualmente
        /// </summary>
